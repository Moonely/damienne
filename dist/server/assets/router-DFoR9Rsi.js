...
const appCss = "/assets/styles-CchVDlA2.css";
...
const $$splitComponentImporter = () => import("./index-Cf6bGXNf.js");
const Route2 = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "10 semaines pour devenir Data Analyst Power BI — un parcours doux, motivant et concret pour Damienne."
    }],
    links: [{
      rel: "preconnect",
      ...
      rel: "stylesheet",
      href: "https://fonts.googleapis.com/css2?family=Fraunces:ital,wght@0,400;0,600;0,700;1,500&display=swap"
    }]
  }),
