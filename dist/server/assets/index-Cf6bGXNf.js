...
const Hammer = createLucideIcon("hammer", __iconNode$9);
const __iconNode$8 = [
  [
    "path",
    {
...
const PartyPopper = createLucideIcon("party-popper", __iconNode$6);
const __iconNode$5 = [
  [
    "path",
    {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            ...
            className: cn(
              ...
              done ? "bg-success border-success text-success-foreground scale-110" : "border-border hover:border-primary hover:bg-primary/5"
            ),
            children: done && /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { className: "h-4 w-4", strokeWidth: 3 })
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center gap-2 mb-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-bold uppercase tracking-wider text-muted-foreground w-10", children: day.day }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: cn("inline-flex items-center gap-1 rounded-full px-2.5 py-0.5 text-xs font-medium", cfg.color), children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { className: "h-3 w-3" }),
              cfg.label
            ] }),
            day.english && day.type !== "english" && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-1 rounded-full bg-english/30 text-english-foreground px-2.5 py-0.5 text-xs font-medium", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Languages, { className: "h-3 w-3" }),
              "+ Anglais"
            ] }),
            day.duration !== "0" && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-1 text-xs text-muted-foreground", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { className: "h-3 w-3" }),
              day.duration
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: cn("font-semibold text-foreground mb-1", done && "line-through opacity-60"), children: day.title }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: cn("text-sm text-muted-foreground leading-relaxed", done && "opacity-60"), children: day.description }),
          day.resources && day.resources.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-3 flex flex-wrap gap-2", children: day.resources.map((r2) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "a",
            {
              href: r2.url,
              target: "_blank",
          ...
          day.win && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-3 inline-flex items-center gap-2 rounded-lg bg-win/30 px-3 py-1.5 text-sm font-medium text-win-foreground", children: day.win })
        ] })
      ] })
    }
  );
...
function WeekCard({ week, defaultOpen = false, doneMap, onToggle }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "rounded-3xl bg-card border shadow-soft overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-4 mb-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: cn("inline-block h-2 w-12 rounded-full bg-gradient-to-r", phaseStyles[week.phase]) }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-2xl md:text-3xl font-bold text-foreground", children: week.title })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              ChevronDown,
              {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground leading-relaxed mb-4", children: week.intro }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap items-center gap-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-sm", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Target, { className: "h-4 w-4 text-primary" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-foreground", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium", children: "Objectif :" }),
              " ",
              week.goal
            ] })
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4 flex items-center gap-3", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-sm font-medium text-muted-foreground tabular-nums", children: [
              doneCount,
              "/",
              week.days.length
            ] })
    ...
    open && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-t bg-gradient-to-b from-background to-card/50 p-6 md:p-8 space-y-3", children: [
      week.days.map((day, i) => {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-6 rounded-2xl bg-gradient-to-br from-win/30 to-primary/15 p-5 flex items-center gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Trophy, { className: "h-8 w-8 text-primary shrink-0" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold uppercase tracking-wider text-muted-foreground mb-1", children: "Récompense de fin de semaine" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-medium text-foreground", children: week.celebration })
        ] })
      ] })
    ] })
  ] });
...
const quotes = ["Tu n'as pas à être parfaite, juste régulière.", "Chaque petit pas compte plus qu'un grand bond.", "La confiance se construit ligne par ligne.", "Tu es exactement là où tu dois être.", "Aujourd'hui, fais juste un peu. C'est déjà beaucoup."];
function Index() {
  const [doneMap, setDoneMap] = reactExports.useState({});
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "min-h-screen pb-24", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "bg-gradient-hero text-primary-foreground", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-5xl mx-auto px-6 py-16 md:py-24", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-flex items-center gap-2 rounded-full bg-white/20 backdrop-blur px-4 py-1.5 text-sm font-medium mb-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Heart, { className: "h-4 w-4" }),
        " Pour Damienne"
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "text-4xl md:text-6xl font-bold leading-tight mb-4", children: [
        "10 semaines pour ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("em", { className: "italic", children: "renaître" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-4 items-center", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl bg-white/15 backdrop-blur px-5 py-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs uppercase tracking-wider opacity-80", children: "Avancement" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-2xl font-bold tabular-nums", children: [
            stats.pct,
            "%"
          ] })
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-8 max-w-xl", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-3 rounded-full bg-white/20 overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-full bg-white transition-all duration-700", style: {
        width: `${stats.pct}%`
      } }) }) })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-3xl mx-auto px-6 -mt-8 mb-12", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl bg-card border shadow-glow p-6 flex items-start gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Quote, { className: "h-6 w-6 text-primary shrink-0 mt-1" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg italic text-foreground leading-relaxed font-medium", style: {
        fontFamily: "var(--font-display)"
      }, children: quote })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "max-w-5xl mx-auto px-6 mb-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl md:text-3xl font-bold mb-6 text-foreground", children: "Le voyage en 4 étapes" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid sm:grid-cols-2 lg:grid-cols-4 gap-4", children: [{
        n: "S 1-2",
        phase: "Confiance",
        desc: "Réveiller les bases, premiers wins visibles",
        icon: Sparkles,
        color: "from-warm to-primary/60"
      }, {
        n: "S 3-5",
        phase: "Intermédiaire",
        desc: "DAX, modèles, visualisations qui font wow",
        icon: TrendingUp,
        color: "from-primary to-secondary/70"
      }, {
        n: "S 6-8",
        phase: "Portfolio",
        desc: "3 projets concrets publiés sur LinkedIn",
        icon: Sparkles,
        color: "from-secondary to-secondary/80"
      }, {
        n: "S 9-10",
        phase: "Job Ready",
        desc: "CV, candidatures, entretiens maîtrisés",
        icon: Heart,
        color: "from-win to-primary"
      }].map((p) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl bg-card border p-5 shadow-soft", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `h-1.5 w-16 rounded-full bg-gradient-to-r ${p.color} mb-4` }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-semibold uppercase tracking-widest text-muted-foreground", children: p.n }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-lg font-bold text-foreground mt-1", children: p.phase }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mt-2 leading-relaxed", children: p.desc })
      ] }, p.n)) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "max-w-5xl mx-auto px-6 space-y-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl md:text-3xl font-bold mb-2 text-foreground", children: "Ton calendrier semaine par semaine" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground mb-6", children: "Clique sur une semaine pour voir tous les détails. Coche au fur et à mesure — ta progression est sauvegardée automatiquement. 💾" }),
      calendar.map((week) => /* @__PURE__ */ jsxRuntimeExports.jsx(WeekCard, { week, defaultOpen: week.number === 1, doneMap, onToggle: toggle }, week.number))
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { className: "max-w-3xl mx-auto px-6 mt-20 text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-3xl bg-gradient-to-br from-primary/10 via-warm/20 to-win/20 p-8 md:p-10", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Heart, { className: "h-8 w-8 text-primary mx-auto mb-4" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-2xl md:text-3xl font-bold text-foreground mb-3", children: "Tu vas y arriver, Damienne." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground leading-relaxed max-w-xl mx-auto", children: "Ce calendrier n'est qu'une carte. La vraie magie, c'est toi qui la fais. Reviens chaque jour. Coche une case. Sois fière. Recommence demain. Dans 10 semaines, tu te retourneras et tu n'en reviendras pas." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-8", children: "Ta progression est sauvegardée localement sur cet appareil." })
    ] })
  ] });
}
export {
